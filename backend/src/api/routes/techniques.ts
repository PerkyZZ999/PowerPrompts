...
const TECHNIQUES_INFO = {
  cot: {
    ...
    description:
      "Breaks down complex reasoning into step-by-step logical progressions",
    enabled: true,
  ...
  rsip: {
    ...
    description:
      "Iteratively critiques and improves the prompt based on metrics",
    enabled: true,
    compatible_with: [
      "cot",
      "self_consistency",
  ...
  prompt_chaining: {
    ...
    description:
      "Executes multiple prompts sequentially, passing outputs as inputs",
    enabled: true,
